   ...
   <!-- LOGO HEADER END-->
	...
	<div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12"  >
                    <h4 class="page-head-line" style="cursor:pointer;"><a href="add_saving.php"> Loan History</a> </h4>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-12">
                   <div class="panel panel-default">
						...
						<form action="" method="post">
                           <div class="col-md-5">	
							...
							<div class="col-md-3">	
								...
								<input type="text" class="form-control" id="Date" name="DATER" value="<?= $Date;?>"/>
							</div>
							<div class="col-md-3">	
								<label class="control-label" for="success">End Date</label>
								<input type="text" class="form-control" id="Date1" name="DATEE" value="<?= $Date;?>"/>
							</div>
						...
						if(strlen($search) > 0){
							$searchG = query("SELECT * FROM s_saving WHERE SHARE_ID = '".$search."'  AND DATE_SAVING BETWEEN '".$DateF."' AND '".$DateE."' AND SAVING_STATUS = 'Active' AND TYPE = 'Loan' ORDER BY SAVING_ID DESC LIMIT $get,30");
						
						}else{
							$searchG = query("SELECT * FROM s_saving WHERE SAVING_STATUS = 'Active' AND DATE_SAVING BETWEEN '".$DateF."' AND '".$DateE."'  AND TYPE = 'Loan' ORDER BY SAVING_ID DESC LIMIT $get,30");
											...
											<table class="table table-striped table-bordered table-hover">
												<thead>
													 <tr>
														...
														<h5>Report Title: Loan History Report</h5>
